...
const Contact: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gray-950 relative overflow-hidden" id="contact">
            ...
            <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">info@roboticlearning.edu</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-800 p-2 rounded-full hover:bg-blue-500/20 transition-colors">
            ...
            <div className="bg-gray-900 p-8 rounded-xl border border-gray-800">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className={`
                    px-6 py-3 rounded-lg flex items-center justify-center transition-all duration-300
                    ${submitted 
