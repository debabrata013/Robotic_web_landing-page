      ...
      <div className="container mx-auto px-4">
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Empowering the next generation of robotics innovators through cutting-edge education and hands-on experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#teachers" className="text-gray-400 hover:text-blue-400 transition-colors">Our Team</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Robotics Fundamentals</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">AI & Machine Learning</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Computer Vision</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Embedded Systems</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Mechatronics</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Subscribe to our newsletter to receive updates and news about our programs.
            </p>
            <div className="flex">
              <input
                type="email"
                className="bg-gray-800 border border-gray-700 text-white px-3 py-2 rounded-l-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div className="py-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © 2025 RoboLearn. All rights reserved.
          </p>
